...
int main() {
    ...
    STAR_CHECK(wide.find("\xE2\x94\x82   Ravi   \xE2\x94\x82") != std::string::npos ||
                   modern::renderChartPair(cs.sun, "Ravi Chart", cs.moon, "Chandra Chart", 80,
                                           false)
                           .find("\xE2\x94\x82   Ravi   \xE2\x94\x82") != std::string::npos,
