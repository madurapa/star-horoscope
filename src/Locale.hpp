...
[[nodiscard]] inline const ConceptText& conceptText(Concept c) noexcept {
    static const ConceptText k[] = {
        ...
        {"Vavuniya"},
        {"Vishkambha"}, {"Preethi"}, {"Ayushman"}, {"Saubhagya"}, {"Shobhana"},
        {"Athiganda"}, {"Sukarma"}, {"Dhriti"}, {"Shula"}, {"Ganda"},
        {"Wruddhi"}, {"Dhruva"}, {"Vyaghatha"}, {"Harshana"}, {"Vajra"},
        {"Siddi"}, {"Vyathipatha"}, {"Varyayan"}, {"Parigha"}, {"Shiva"},
        {"Sidda"}, {"Saadaya"}, {"Shubha"}, {"Shukla"}, {"Brahma"},
        {"Indra"}, {"Vaidhriti"},
        ...
        {"Kimstughna"}, {"Bava"}, {"Baalava"}, {"Kavlava"}, {"Thithila"},
